    ...
    <section id="experience" className="py-24 bg-stone-50 dark:bg-stone-950 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl mt-2">Experience</h2>
          <div className="h-1 w-20 bg-primary mx-auto mt-4 rounded-full" />
        </motion.div>

        <div className="max-w-3xl mx-auto relative">
          {/* Timeline Line */}
          <div className="absolute left-0 sm:left-1/2 top-0 bottom-0 w-px bg-slate-300 dark:bg-gray-800 -translate-x-1/2" />
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full sm:w-1/2 ${isEven ? 'sm:pr-8' : 'sm:pl-8'} pl-10 sm:pl-0 mt-4 sm:mt-0`}>
                    <div className="p-6 rounded-2xl glass-panel border border-slate-200 dark:border-gray-800 hover:border-primary/30 transition-colors shadow-sm">
                      {/* Date (Mobile) */}
                      <span className="sm:hidden text-xs font-mono font-medium text-primary block mb-2">{exp.date}</span>
                      
                      <h3 className="text-xl font-bold text-slate-900 dark:text-white">{exp.role}</h3>
                      <p className="text-slate-500 dark:text-gray-400 font-medium mb-4">{exp.company}</p>
