          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.6, delay: 0.08 }} className="relative">
            ...
            <div className="space-y-6 max-w-[68ch]">
              <p className="font-sans text-[16.5px] sm:text-[18px] leading-[1.85] tracking-[-0.01em] text-stone-100 font-normal antialiased">
                Full stack software developer with 2+ years of experience across frontend, backend, cloud infrastructure and database design building interfaces in <span className="font-medium text-amber-300">React/Next.js</span>, APIs in <span className="font-medium text-amber-300">Node.js/Express</span> and deploying on AWS. ALSO A CERTIFIED CLOUD PRACTITIONER. I build reliable, production-ready products end to end: architecting marketplaces and FinOps tools, engineering secure payment and auth workflows, and love problem solving.
              </p>
